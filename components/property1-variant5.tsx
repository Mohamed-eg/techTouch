...
type Property1Variant5Type = {
  wishlist?: string;

  /** Style props */
  property1Variant5FlexShrink?: CSSProperties["flexShrink"];
};

const Property1Variant5: NextPage<Property1Variant5Type> = ({
  wishlist,
  property1Variant5FlexShrink,
}) => {
  const property1Variant5Style: CSSProperties = useMemo(() => {
    return {
      flexShrink: property1Variant5FlexShrink,
    };
  }, [property1Variant5FlexShrink]);
  ...
  return (
    ...
    >
      ...
      <div className="shrink-0 flex flex-col items-start justify-start gap-[8px] text-base text-text2">
        ...
        <ColourChnage
          group1000005935="/group-1000005935@2x.png"
          colourChnageFlexShrink="0"
