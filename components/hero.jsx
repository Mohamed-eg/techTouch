...
import appleImg from "../public/icons-arrowright@2x.png";

const Hero = () => {
  return (
    <section
      className="w-full bg-text2 overflow-hidden flex flex-col items-center justify-center"
      id="hero">
      <section
        ...
        <div className="w-full my-0 flex flex-row items-center justify-around z-[0]">
          <div className=" flex flex-col items-center justify-center gap-[80px] w-[40%] ">
            ...
            <a
              className="[text-decoration:none] mb-[20px] flex flex-row items-center justify-start gap-[8px] text-[11px] w-[82px] text-white"
              href={`"#products"`}>
